...
### peace by decade
peace_word_frequencies_topfive %>% ggvis(~years, ~peace) %>% layer_lines(stroke = 'peace') %>% add_axis("x", title = "Importance of words in peace nobel prize for peace speeches(by decades)")    %>% add_axis("y", title = "Word frequency") %>% layer_paths(y = ~world, stroke = 'world') %>% layer_paths(y = ~will, stroke = 'will') %>% layer_paths(y = ~war, stroke = 'war') %>% layer_paths(y = ~people, stroke = 'one')
...
str(literature_word_frequencies_topfive)
